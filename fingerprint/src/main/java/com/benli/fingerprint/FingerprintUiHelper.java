 ...
 */
@TargetApi(Build.VERSION_CODES.M) public class FingerprintUiHelper
  ...
  /**
   * The timeout for the success to be displayed. Calls {@link Callback#onAuthenticated()} after
   * this.
   */
  ...
  public static class FingerprintUiHelperBuilder {
    ...
    public FingerprintUiHelper build(ImageView icon, TextView errorTextView, Callback callback) {
      return new FingerprintUiHelper(mContext, icon, errorTextView, callback);
    }
  }
   ...
   */
  private FingerprintUiHelper(Context context, ImageView icon, TextView errorTextView,
      Callback callback) {
    mContext = context;
    mIcon = icon;
  ...
  public boolean startfingerprint() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      ...
      try {
        if (mFingerprintManager.isHardwareDetected() && isFingerprintAuthAvailable()) {
  ...
  @Override public void onAuthenticationFailed() {
    showError(mIcon.getResources().getString(R.string.pin_code_fingerprint_not_recognized));
  }
  ...
  /**
   * Tells if the {@link FingerprintManager#isHardwareDetected()}, {@link
  ...
  public boolean isFingerprintAuthAvailable() throws SecurityException {
    return mFingerprintManager.isHardwareDetected()
        ...
        && ((KeyguardManager) mIcon.getContext()
        .getSystemService(Context.KEYGUARD_SERVICE)).isDeviceSecure();
  }
